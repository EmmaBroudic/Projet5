          ...
          <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <!-- Bouton "pr\xe9c\xe9dent" ou \xe9l\xe9ment vide en fonction de la valeur de navigation -->
                ...
                <!-- Bouton "suivant" ou \xe9l\xe9ment vide en fonction de la valeur de navigation -->
              </div>
            </div>
          </div>
                ...
                <span class="nav-link" data-images-toggle="${t}">${t}</span></li>`});var s=`<ul class="my-4 tags-bar nav nav-pills">${i}</ul>`;"bottom"===e?t.append(s):"top"===e?t.prepend(s):console.error(`Unknown tags position: ${e}`)},filterByTag(){if(!a(this).hasClass("active-tag")){a(".active-tag").removeClass("active active-tag"),a(this).addClass("active-tag");var t=a(this).data("images-toggle");a(".nav-link").removeClass("active"),a(`.nav-link[data-images-toggle="${t}"]`).addClass("active"),a(".gallery-item").each(function(){a(this).parents(".item-column").hide(),"all"===t?a(this).parents(".item-column").show(300):a(this).data("gallery-tag")===t&&a(this).parents(".item-column").show(300)})}}}}(jQuery);